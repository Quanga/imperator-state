...
NodeRepository.prototype.insertNodeData = function($happn, parsedPacket) {
	let insertNode = async () => {
		...
		try {
			...
			// if (parsedPacket.type_id == 4 && parsedPacket.serial == 4294967295) {
			// 	await this.archiveEdds();
			// }

...
class BlastModel {
	 ...
	 * @param {string} serial Data Model SnapShot Object
	...
	/**
	 * @summary Function to take in a snapshot from the Data Model and work out the format
	...
	extractWatchLists(units) {
		...
		unitKeys.forEach(unitKey => {
			if (Object.prototype.hasOwnProperty.call(units[unitKey], "children")) {
		...
		switch (typeId) {
			case 0:
				if (
					...
					console.log("logObj", JSON.stringify(logObj, null, 2));

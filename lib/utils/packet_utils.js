...
PacketUtils.prototype.extractRawData = function(
	...
	console.log(":::::::::::::: bittemplate", bitTemplate);
	console.log(":::::::::::::: result object", result);
	console.log(":::::::::::::: parsedPacket object", parsedPacket);

	for (let bitKey in bitTemplate) {
		if (result.hasOwnProperty(bitKey)) {
			let currentBit = bitTemplate[bitKey];

			console.log(
				`setting ${bitKey} to ${parsedPacket.data.raw[currentBit.index]}`
			);
			let parsedData = parsedPacket.data.raw[currentBit.index];
			if (parsedData !== null) {
				result[bitKey] = parsedData;
			}
		}
	}

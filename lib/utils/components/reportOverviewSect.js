...
const reportOverviewSect = function(reportObj, theme) {
	const { createdAt, firingComplete, blastClosed, id, state } = reportObj;
	try {
		return [
			{
				table: {
					...
					body: [
						...
						[
							...
							{
								text: utils.generateDate(createdAt, "DATE") || "NA",
								style: "standard"
							},
							{
							...
							{
								text: utils.generateDate(createdAt, "TIME") || "NA",
								style: "standard"
							},
							{
				...
				table: {
					...
					body: [
						...
						[
							...
							{ text: "", style: "standard" },
							{
								text: `${getSeconds(firingComplete, createdAt)} sec`,
								style: "standard"
							},
							{

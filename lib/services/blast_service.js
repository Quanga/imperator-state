...
BlastService.prototype.createNewBlast = function($happn, created, snapShot) {
	...
	const subscribeToLogs = async () => {
		this.currentBlast.blastEvent.on("BLAST_DATA_COMPLETE", () => {
			blastService.closeBlast();
		});

		this.currentBlast.blastEvent.on("BLAST_TIMER_COMPLETE", () => {
			blastService.closeBlast();
		});
...
BlastService.prototype.closeBlast = function($happn) {
	...
	return (async () => {
		try {
			...
			this.currentBlast.blastEvent.removeAllListeners("BLAST_DATA_COMPLETE");
			this.currentBlast.blastEvent.removeAllListeners("BLAST_TIMER_COMPLETE");

...
DataService.prototype.__createLogs = function($happn, updatedNode) {
	...
	const { incomingCommands } = this.__constants;
	...
	let createLogsAsync = async () => {
		...
		case 0:
			...
			break;
		case 1:
			constantData = incomingCommands[3].data.first_byte.bits;
			break;
		case 2:
			constantData = incomingCommands[3].data.remaining_bytes.bits;
			break;
		case 3:
			constantData = incomingCommands[5].data.first_byte.bits;
			break;
		}

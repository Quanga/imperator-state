 ...
 * @returns {Promise}
 */
DataService.prototype.rehydrateData = function($happn, persisted) {
	const { dataService } = $happn.exchange;
	const { log } = $happn;
 ...
 * @returns {Promise}
 */
DataService.prototype.upsertNodeDataArr = function($happn, nodeArr, withEmit) {
	const { dataService } = $happn.exchange;
	const { log } = $happn;
...
DataService.prototype.reportUpserts = function($happn, context) {
	const { log, emit } = $happn;

...
IncomingMessageReader.prototype.getReadFunc = function(options, callback) {
	try {
		var result = this.readline(options.startDelimiter);
...
IncomingMessageReader.prototype.readline = function(startDelimiter, encoding) {
	...
	return function(emitter, buffer) {
		...
		parts.forEach(function(part) {
			...
			if (partsLen == 1 && part.length >= 2) hexLen = parts[0].substr(0, 2);

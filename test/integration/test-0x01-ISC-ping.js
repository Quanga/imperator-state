        ...
        async.waterfall([
                ...
                function (cb) {
                    setTimeout(function () {
                        ...
                        databaseHelper.getNodeTreeData(1, 0)
                            .then(function (result) {

                                if (result == null || result.length == 0)
                                    return cb(new Error('Empty result!'));

                                var isc1 = null, isc2 = null, isc3 = null;

                                result.forEach(x => {
                                    if (x["c.serial"] == 1 && x["c.type_id"] == 1)
                                        isc1 = x;

                                    if (x["c.serial"] == 2 && x["c.type_id"] == 1)
                                        isc2 = x;

                                    if (x["c.serial"] == 3 && x["c.type_id"] == 1)
                                        isc3 = x;
                                });
                ...
                setTimeout(function () {
                    ...
                    databaseHelper.getNodeTreeData(1, 0)
                        .then(function (result) {
                            ...
                            var isc1 = null, isc2 = null, isc3 = null, isc4 = null;
